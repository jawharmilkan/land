 ...
 * @author jawhar
 */
public class FinanceDepartmentFinancialRecordUpdateRecordAndViewChartController implements Initializable {
    ...
    {
           Parent scene2Parent = FXMLLoader.load(getClass().getResource("FinanceDepartmentViewChartScene.fxml"));
